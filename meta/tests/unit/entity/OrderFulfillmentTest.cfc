...
component extends="Slatwall.meta.tests.unit.entity.SlatwallEntityTestBase" {
	...
	public void function getFulfillmentTotalTest(){
		...
		assertEquals(135.35423,orderFulfillment.getFulfillmentTotal());
	}
	...
	public void function getSubtotalAfterDiscountsTest(){
		...
		assertEquals(85950.2012,orderfulfillment.getSubtotalAfterDiscounts());
	}
	...
	public void function getSubtotalAfterDiscountsWithTaxTest(){
		...
		assertEquals(984684.641,orderfulfillment.getSubtotalAfterDiscountsWithTax());
	}
	...
	public void function getTaxAmountTest(){
		...
		assertEquals(1797468.8796,orderFulfillment.getTaxAmount());
	}
