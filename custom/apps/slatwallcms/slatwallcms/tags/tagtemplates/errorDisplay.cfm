<cfoutput>
    ...
    <div class="px-2 mt-1 bg-danger text-white" ng-show="slatwall.requests[swfForm.method].errors.#listLast(attributes.propertyIdentifier,'.')#" ng-repeat="error in slatwall.requests[swfForm.method].errors.#listLast(attributes.propertyIdentifier,'.')#" ng-bind="error">
