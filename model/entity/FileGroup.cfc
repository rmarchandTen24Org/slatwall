...
*/
component displayname="File Group" entityname="SlatwallFileGoup" table="SwFileGroup" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="fileService" hb_permission="this" {
	...
	property name="fileGroupDescription" ormtype="string" length="4000";
