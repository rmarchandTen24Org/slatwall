...
*/
component displayname="Note" entityname="SlatwallNote" table="SwNote" persistent="true" accessors="true" output="false" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="noteService" hb_permission="this" {
	
	// Persistent Properties
	property name="noteID" ormtype="string" length="32" fieldtype="id" generator="uuid" unsavedvalue="" default="";
	property name="noteName" hb_populateEnabled="public" ormtype="string" hint="Title for the note.";
	property name="noteContent" hb_populateEnabled="public" ormtype="string" length="4000"; 
