		...
		<hb:HibachiPropertyRow>
			<hb:HibachiPropertyList>
				...
				<!--- New Payment Method  --->
					...
					<hb:HibachiDisplayToggle selector="select[name='accountPaymentMethodID']" loadVisable="#!len(rc.processObject.getAccountPaymentMethodID())#">
							
						<input type="hidden" name="newAccountPayment.accountPaymentID" value="" />
						<hb:HibachiDisplayToggle selector="select[name='newAccountPayment.accountPaymentType.typeID']" loadVisible="#rc.processObject.getNewAccountPayment().getAccountPaymentTypeOptions()[1]['value'] neq '68e3fb57d8102b47acc0003906d16ddd'#" showValues="444df32e9b448ea196c18c66e1454c46,444df32dd2b0583d59a19f1b77869025">			
							<!--- New Payment Type --->
							...
							<cfset loadVisable = arrayLen(rc.processObject.getNewAccountPayment().getPaymentMethodOptions()) 
								&&structKeyExists(rc.processObject.getNewAccountPayment().getPaymentMethodOptions()[1],'allowsave')
								&& rc.processObject.getNewAccountPayment().getPaymentMethodOptions()[1]['allowsave'] />
							...
							<cfset loadPaymentMethodType = arrayLen(rc.processObject.getNewAccountPayment().getPaymentMethodOptions()) 
								&&structKeyExists(rc.processObject.getNewAccountPayment().getPaymentMethodOptions()[1],'paymentmethodtype')
								&& rc.processObject.getNewAccountPayment().getPaymentMethodOptions()[1]['paymentmethodtype'] 
