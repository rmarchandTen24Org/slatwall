...
class test{
    constructor(
        ...
        describe('swValidationGte Test',()=>{
            ...
            beforeEach(()=>{
                ...
                angular.mock.module(($provide)=>{
                    $provide.service('validationService', ()=>{
                        return {
                            validateGte: (value, comparisonValue)=>{
            ...
            it('Should be valid if value is greater than comparison value',()=>{
                form.valueInput.$setViewValue('11');
                $rootScope.$digest();
                expect(form.valueInput.$error.swValidationGte).toBeFalsy();
            });

            it('Should be invalid if value is less than comparison value', ()=>{
